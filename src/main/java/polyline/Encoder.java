...
public class Encoder {
    ...
    public Encoder(int numLevels, int zoomFactor, double verySmall, boolean forceEndpoints) {
     ...
     * 
     */
    private HashMap<String, String> dpEncode(Track track) {
        int i, maxLoc = 0;
     ...
     * @return
     */
    private double distance(Trackpoint p0, Trackpoint p1, Trackpoint p2) {
        double u, out = 0.0;
     ...
     */
    private Track pointsToTrack(String points) {
        Track trk = new Track();
     ...
     */
    private Track kmlLineStringToTrack(String points) {
        Track trk = new Track();
        StringTokenizer st = new StringTokenizer(points, " ");
     ...
     * @return
     */
    private Track pointsAndAltitudeToTrack(String points) {
    ...
    public HashMap createEncodings(Track track, int level, int step) {
