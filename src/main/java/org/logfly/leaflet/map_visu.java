...
import org.logfly.trackgps.thermique;
...
public class map_visu {
    ...
    private boolean genThermData(traceGPS traceVisu)   {
        ...
        if (totPoints > 0) {
            ...
            dBestT = (org.logfly.geoutils.trigo.CoordDistance(bestPoint2.Latitude,bestPoint2.Longitude,bestPoint1.Latitude,bestPoint1.Longitude))/1000;
